...
CONFIG = {
    ...
    "autoab_grabid": os.environ.get("AUTOAB_GRABID", "132"),
...
def main():
    ...
    for order in new_orders:
        print(f"  -> 订单 #{order['id']}: {order['order_amount']} 马币 - {order.get('from_location', '')[:20]}")
